...
- (void)setUpViewWithTimeDic:(NSMutableDictionary *)dic_time addressDic:(NSMutableDictionary *)dic_address tempratureDic:(NSMutableDictionary *)dic_temprature
{
    ...
    if ([dateFormate isEqualToString:@"dd-mm-yyyy"]) {
        str_date = [NSString stringWithFormat:@"%@, %@  %@  %@",[dic_time objectForKey:@"currentFullWeekName"],[dic_time objectForKey:@"currentDate"],[dic_time objectForKey:@"currentShortMonthName"],[dic_time objectForKey:@"currentYear"]];
    }
    else if ([dateFormate isEqualToString:@"mm-dd-yyyy"]) {
        str_date = [NSString stringWithFormat:@"%@, %@ %@ %@",[dic_time objectForKey:@"currentFullWeekName"],[dic_time objectForKey:@"currentShortMonthName"],[dic_time objectForKey:@"currentDate"],[dic_time objectForKey:@"currentYear"]];
    }
    else if ([dateFormate isEqualToString:@"yyyy-mm-dd"]) {
        str_date = [NSString stringWithFormat:@"%@, %@ %@ %@",[dic_time objectForKey:@"currentFullWeekName"],[dic_time objectForKey:@"currentYear"],[dic_time objectForKey:@"currentShortMonthName"],[dic_time objectForKey:@"currentDate"]];
    }
